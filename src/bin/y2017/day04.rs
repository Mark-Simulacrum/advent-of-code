...
#[test]
fn part1_3() {
    assert!(!is_valid_part1("aa bb cc dd aa"));
}

#[test]
fn part1_actual() {
    assert_eq!(part1(INPUT), 455);
}
...
#[test]
fn part2_2() {
    assert!(!is_valid_part2("abcde xyz ecdab"));
}
...
#[test]
fn part2_5() {
    assert!(!is_valid_part2("oiii ioii iioi iiio"));
}
